...
7. Keep the app in a place you can find, such as Downloads or Desktop.

## 🔧 First-Time Setup

1. Start Pi if it is not already open.
2. Launch `pi-verbosity-control`.
3. Check that the app detects your available models.
4. Select the model you want to change.
5. Pick a verbosity level.
6. Save the setting.
7. Look at the inline footer to confirm the current value.

## 🎛️ How to Use It

### Set a model's verbosity
- Open the app
- Choose a model
- Select the verbosity you want
- Save the change

### Read the footer display
- The footer shows the active verbosity
- It updates when you switch models
- It helps you confirm the setting at a glance

### Change verbosity later
- Open the app again
...
### Can I change settings for more than one model?
